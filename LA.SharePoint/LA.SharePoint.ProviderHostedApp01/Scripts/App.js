...
// Questa funzione prepara, carica e quindi esegue una query di SharePoint per ottenere le informazioni correnti degli utenti
function getUserName() {
    context.load(user);
    context.executeQueryAsync(onGetUserNameSuccess, onGetUserNameFail);
}

// Questa funzione viene eseguita se la chiamata sopra indicata ha esito positivo
